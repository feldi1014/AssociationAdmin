...
namespace SplitOrders
{
    internal class DataSetHelper
    {
        ...
        internal void AppendColumnMitgliedsJahre(string tableName)
        {
        ...
        internal void SetPrimaryKey(string tableName, string keyColumn)
        {
        ...
        internal void AppendColumnsForLastYear()
        {
